...
const BookEditScreen = () => {
  ...
  useEffect(() => {
    if (book) {
      ...
      setImage(book.image);
      setSellingPrice(book.sellingPrice);
      setPrintingCost(book.printingCost);
      setPackagingCost(book.packagingCost);
      setHandlingCost(book.handlingCost);
      setAmazonPlatformFee(book.amazonPlatformFee);
      setAmazonRoyalty(book.amazonRoyalty);
      setAmazonUrl(book.amazonUrl);
      setFlipkartPlatformFee(book.flipkartPlatformFee);
      setFlipkartRoyalty(book.flipkartRoyalty);
      setFlipkartUrl(book.flipkartUrl);
      setKindlePlatformFee(book.kindlePlatformFee);
      setKindleRoyalty(book.kindleRoyalty);
